...
export default function PrimarySearchAppBar() {
  ...
  const ls = localStorage.getItem("isLogin")
  ...
  const renderCompUserData = (
    <>
      <p style={{ color: "orange", fontWeight: 600, marginRight: "1rem" }}>
        Marybeth Services
      </p>
    </>
  );
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ background: "white" }}>
        <Toolbar>
          ...
          >
            {ls.includes("true") ? renderCompUserData : null}
            {ls.includes("true") ? renderLogOut : null}
          </div>
        </Toolbar>
      </AppBar>
      {renderMobileMenu}
